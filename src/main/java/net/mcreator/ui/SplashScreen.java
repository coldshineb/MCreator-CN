...
public class SplashScreen extends JWindow {
	...
	public SplashScreen() {
		try {
			splashFont = Font.createFont(Font.TRUETYPE_FONT,
					Objects.requireNonNull(getClass().getResourceAsStream("/fonts/notomono.ttf")));
		...
		JLabel label = new JLabel(
				"<html><p>MCreator 是 Pylo 开发的 Minecraft 模组制作工具包。Minecraft 是</p>"
						+ "<p style='margin-top:-2'>Mojang AB 的注册商标。 MCreator 不是 Minecraft 的官方产品。此产品与<br>Mojang AB 无任何联系。");
		...
		JLabel version = new JLabel(
				"版本 " + (Launcher.version != null ? Launcher.version.getMajorString() : "1234.5")+ " 泠汐希晴曦版");
